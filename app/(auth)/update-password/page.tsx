          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
                minLength={6}
                className="mt-2 block w-full rounded-lg border-0 bg-slate-950 py-3 text-white shadow-sm ring-1 ring-inset ring-slate-800 placeholder:text-slate-600 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6 pl-4 transition-all"
              />
            </div>
